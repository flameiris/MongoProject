...
namespace Iris.Ocelot.Middlewares.LimitRater.Middleware
{
    public class BlackListRateLimitMiddleware : OcelotMiddleware
    {
        private readonly OcelotRequestDelegate _next;
        private readonly IRateLimitCounterHandler _counterHandler;
        private readonly ClientRateLimitProcessor _processor;

        public BlackListRateLimitMiddleware(OcelotRequestDelegate next,
            IOcelotLoggerFactory loggerFactory,
            IRateLimitCounterHandler counterHandler)
                : base(loggerFactory.CreateLogger<BlackListRateLimitMiddleware>())
        {
            _next = next;
