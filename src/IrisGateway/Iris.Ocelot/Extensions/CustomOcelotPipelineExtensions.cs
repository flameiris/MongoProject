using Iris.Ocelot.Middlewares.Responder.Middleware;
...
{
    public static class CustomOcelotPipelineExtensions
    {
        ...
        /// <returns></returns>
        public static OcelotRequestDelegate BuildCustomOcelotPipeline(this IOcelotPipelineBuilder builder,
            OcelotPipelineConfiguration pipelineConfiguration)
        {
            ...
            //自定义错误抓取
            builder.UseCustomResponderMiddleware();
            ...
            //builder.UseCustomAuthenticationMiddleware();
